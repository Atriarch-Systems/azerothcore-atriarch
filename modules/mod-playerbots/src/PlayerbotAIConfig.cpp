...
bool PlayerbotAIConfig::Initialize()
{
    ...
    // Ratio (0.0 - 1.0) probability for a random bot to be created as female. Default 0.5 keeps original behavior.
    randomBotFemaleRatio = sConfigMgr->GetOption<float>("AiPlayerbot.RandomBotFemaleRatio", 0.5f);
